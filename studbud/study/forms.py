...
class StudentForm(ModelForm):
    ...
    time_management = forms.ChoiceField(choices = TIME_MANAGEMENT_CHOICES, initial = 0, widget = forms.RadioSelect(attrs={'display': 'inline-block',}), label = 'How do you manage your time for assignments?')
    ...
    course_instances = forms.ModelMultipleChoiceField(queryset = CourseInstance.objects.all())
