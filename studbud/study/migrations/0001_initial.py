    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.CharField(choices=[('spring_2021', 'Spring 2021'), ('summer_2021', 'Summer 2021')], default='', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_instances', models.ManyToManyField(to='study.CourseInstance')),
            ],
        ),
        migrations.CreateModel(
            name='StudyGroup',
        ...
        migrations.AddField(
            ...
            name='professor',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='study.professor'),
        ),
    ]
